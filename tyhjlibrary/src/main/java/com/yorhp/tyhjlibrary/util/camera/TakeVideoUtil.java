...
public class TakeVideoUtil {
    ...
    private TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture,
            ...
            openCamera(width, height,context);
        }
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture,
                                                int width, int height) {
            configureTransform(width, height,context);
        }
    ...
    private CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(@NonNull CameraDevice cameraDevice) {
            ...
            if (null != mTextureView) {
                configureTransform(mTextureView.getWidth(), mTextureView.getHeight(),context);
            }
        }
    ...
    private static Size chooseOptimalSize(Size[] choices, int width, int height, Size aspectRatio) {
        ...
        if (bigEnough.size() > 0) {
            return Collections.min(bigEnough, new ShootVideoActivity.CompareSizesByArea());
        } else {
    ...
    public void openCamera(int width, int height,Context context) {
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private void configureTransform(int viewWidth, int viewHeight,Context context) {
    ...
    public void initCamera(){
        ...
        if (mTextureView.isAvailable()) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                openCamera(mTextureView.getWidth(), mTextureView.getHeight(),context);
            }
        } else {
    ...
    public static class ErrorDialog extends DialogFragment {
        ...
        public static ShootVideoActivity.ErrorDialog newInstance(String message) {
            ShootVideoActivity.ErrorDialog dialog = new ShootVideoActivity.ErrorDialog();
