package com.yorhp.tyhjlibrary.util.appVersion;
...
// 并且必须是系统应用该方法才有效
    ...
    public static void installApk(String filePath, Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(activity, "com.yorhp.mlratingstudio.fileProvider", new File(filePath));
