package com.yorhp.tyhjlibrary.util.internet;
...
public class InternetUtil {
    ...
    public static boolean isOnline() {
        ConnectivityManager con = (ConnectivityManager) MyApplication.getInstance().getSystemService(Activity.CONNECTIVITY_SERVICE);
